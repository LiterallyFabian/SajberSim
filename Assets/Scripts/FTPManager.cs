...
public class FTPManager : MonoBehaviour {
    ...
    //Can be set in Discord/Webhook.cs
    private const string SERVER = Credentials.ftp;
    private const string SERVER_PASSWORD = Credentials.ftppass;
    private const string SERVER_USERNAME = Credentials.ftpuser;
