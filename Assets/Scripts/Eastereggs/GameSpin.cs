...
public class GameSpin : MonoBehaviour
{
    ...
    private IEnumerator Run() //time: 14.4s
    {
        ...
        GameObject.Find("Canvas/ButtonPlay").GetComponent<Text>().text = string.Join(" ", Translate.Get("help").ToLower().ToCharArray()); ;
        profilepic.transform.localScale = new Vector3(1, -1, 1);
        yield return new WaitForSeconds(1);
        GameObject.Find("Canvas/ButtonLoad").GetComponent<Text>().text = string.Join("  ", Translate.Get("help").ToLower().ToCharArray()); ;
        ...
        yield return new WaitForSeconds(1);
        GameObject.Find("Canvas/ButtonFind").GetComponent<Text>().text = string.Join("   ", Translate.Get("help").ToLower().ToCharArray()); ;
        yield return new WaitForSeconds(1);
        GameObject.Find("Canvas/ButtonSettings").GetComponent<Text>().text = string.Join("    ", Translate.Get("help").ToLower().ToCharArray()); ;
        yield return new WaitForSeconds(1);
